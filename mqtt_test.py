...
SENSOR_GROUP_MAP = {
    ...
    "Greenhouse-sensor": [
        {"group_id": 1, "table": "Greenhouse_table"},
        {"group_id": 9, "table": "Greenhouse_table"}
    ]
}
...
APEX_ENDPOINTS = {
    ...
    "water_table": "/ords/g3_data/irrigation/",
    "Crop_table": "/ords/g3_data/soil_vision/",
    "Greenhouse_table": "/ords/g3_data/greenhouse/"
}
